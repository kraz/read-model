...
use Kraz\ReadModel\DataSource2;
...
#[CoversClass(DataSource2::class)]
final class DataSource2Test extends TestCase
{
    ...
    {
        /** @var DataSource2<PersonFixture> $ds */
        $ds = new DataSource2(null);
    ...
    {
        /** @var DataSource2<PersonFixture> $ds */
        $ds = new DataSource2($this->people());
    ...
    {
        /** @var DataSource2<PersonFixture> $ds */
        $ds = new DataSource2($this->peopleArray());
